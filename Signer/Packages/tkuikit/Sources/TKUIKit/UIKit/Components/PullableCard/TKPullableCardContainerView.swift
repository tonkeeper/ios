...
public final class TKPullableCardContainerView: TKPassthroughView {
  ...
  var contentHeight: CGFloat = 0 {
    didSet {
      ...
      + headerView.systemLayoutSizeFitting(CGSize(width: bounds.width, height: 0)).height
  ...
  let headerView = TKPullableCardHeaderView()
...
private extension TKPullableCardContainerView {
  func setup() {
    addSubview(mainView)
