...
public protocol TKButtonTextContent: TKButtonContent {
  func setTextStyle(_ textStyle: TKTextStyle)
}
...
public final class TKButtonControl<ButtonContent: TKButtonContent>: UIControl, ConfigurableView {
