    ...
    public enum Battery {
        ...
        public enum Refill {
            ...
            public enum Refunded {
                /// refunded
                public static let few = TKLocales.tr("Localizable", "battery.refill.refunded.few", fallback: "refunded")
                /// refunded
                public static let many = TKLocales.tr("Localizable", "battery.refill.refunded.many", fallback: "refunded")
                /// refunded
                public static let one = TKLocales.tr("Localizable", "battery.refill.refunded.one", fallback: "refunded")
                /// refunded
                public static let other = TKLocales.tr("Localizable", "battery.refill.refunded.other", fallback: "refunded")
                /// refunded
                public static let zero = TKLocales.tr("Localizable", "battery.refill.refunded.zero", fallback: "refunded")
            }
