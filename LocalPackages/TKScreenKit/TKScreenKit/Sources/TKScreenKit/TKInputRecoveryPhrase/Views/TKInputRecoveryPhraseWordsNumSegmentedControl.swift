...
final class TKInputRecoveryPhraseWordsNumSegmentedControl: UIControl, ConfigurableView {
  ...
  func configure(model: Model) {
    UIView.performWithoutAnimation {
      ...
      model.tabs.enumerated().forEach { index, tab in
        let tabView = TKInputRecoveryPhraseWordsNumSegmentedControlTabView()
        tabView.configure(model: TKInputRecoveryPhraseWordsNumSegmentedControlTabView.Model(title: tab))
...
private final class TKInputRecoveryPhraseWordsNumSegmentedControlTabView: UIControl, ConfigurableView {
