...
public struct SendConfirm: Codable, JSONEncodable, Hashable {
    ...
    public var eventName: String = "send_confirm"
    ...
    public init(eventName: String = "send_confirm", from: From, assetNetwork: String, tokenSymbol: String, amount: Double, feePaidIn: FeePaidIn, appId: String? = nil) {
