...
public struct SendSuccess: Codable, JSONEncodable, Hashable {
    ...
    /** Transaction ID of the successful send */
    public var transactionId: String
    /** Required if from=tonconnect_local; same as app_id in dapp_* events */
    public var appId: String?

    public init(eventName: String = "send_success", from: From, assetNetwork: String, tokenSymbol: String, amount: Double, feePaidIn: FeePaidIn, transactionId: String, appId: String? = nil) {
