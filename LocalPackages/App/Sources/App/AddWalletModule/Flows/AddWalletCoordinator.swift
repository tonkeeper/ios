...
public final class AddWalletCoordinator: RouterCoordinator<ViewControllerRouter> {
    ...
    init(
        ...
        self.options = Self.filterOptions(options)
...
private extension AddWalletCoordinator {
    static func filterOptions(_ options: [AddWalletOption]) -> [AddWalletOption] {
        guard !TKFeatureFlags.localProvider.isTetraWalletEnabled else { return options }
