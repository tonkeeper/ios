...
final class CustomizeWalletView: UIView, ConfigurableView {
    ...
    private lazy var continueButtonContainerBottomConstraint: NSLayoutConstraint = continueButtonContainer.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor)
