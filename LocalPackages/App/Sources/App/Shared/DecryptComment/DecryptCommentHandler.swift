...
enum DecryptCommentHandler {
    static func decryptComment<ParentRouterViewController: UIViewController>(
        wallet: Wallet,
        ...
        if appSettings.isDecryptCommentWarningDoNotShow {
            ...
            showDecryptCommentWarningPopup(
                fromViewController: parentRouter.rootViewController.topPresentedViewController(),
    ...
    static func showDecryptCommentWarningPopup(
