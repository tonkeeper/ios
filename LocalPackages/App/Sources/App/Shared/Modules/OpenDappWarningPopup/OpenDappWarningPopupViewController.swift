...
final class OpenDappWarningPopupViewController: UIViewController, TKBottomSheetScrollContentViewController {
    private let viewModel: OpenDappWarningPopupViewModel

    private let modalCardViewController = TKPopUp.ViewController()

    init(viewModel: OpenDappWarningPopupViewModel) {
