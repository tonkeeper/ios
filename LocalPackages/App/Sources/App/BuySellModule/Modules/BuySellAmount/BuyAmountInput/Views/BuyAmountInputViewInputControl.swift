...
final class BuyAmountInputViewInputControl: UIControl {
  ...
  override func layoutSubviews() {
    ...
    let containerWidth = amountTextField.frame.width + currencyLabel.frame.width + .currencyInputLeftInset
...
private extension BuyAmountInputViewInputControl {
  func setup() {
  ...
  func updateAppearance() {
    ...
    let availableWidth = bounds.width - .currencyInputLeftInset - .sidePadding - .sidePadding
