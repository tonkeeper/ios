...
final class BatteryRefillViewModelImplementation: BatteryRefillViewModel, BatteryRefillModuleOutput, BatteryRefillModuleInput {
    ...
    private func createInAppPurchaseSnapshotItem(item: BatteryIAPItem) -> BatteryRefill.SnapshotItem {
        ...
        case let .amount(amount):
            let value = amountFormatter.format(
                ...
                accessory: .currency(amount.currency),
                style: .compact
            )
            buttonTitle = value
        case .loading:
    ...
    private func createSettingsCellConfiguration() -> TKListItemCell.Configuration {
        ...
        let caption = String(
            format: "%@ %@, %@ %@ %@",
            TKLocales.Battery.Refill.Settings.caption,
            TKLocales.Battery.Refill.Settings.Caption.Items.swaps,
            TKLocales.Battery.Refill.Settings.Caption.Items.tokenTransfers,
            TKLocales.Common.and,
            TKLocales.Battery.Refill.Settings.Caption.Items.nftTransfers
        )
