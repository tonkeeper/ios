...
final class BatteryRefillViewController: GenericViewViewController<BatteryRefillView>, KeyboardObserving {
    ...
    init(
        viewModel: BatteryRefillViewModel,
...
private extension BatteryRefillViewController {
    ...
    func createDataSource() -> BatteryRefill.DataSource {
        ...
        return BatteryRefill.DataSource(
            ...
            case let .listItem(listItem):
                ...
                return cell
            case let .inAppPurchase(purhaseItem):
            ...
            case .footer:
                ...
                return collectionView.dequeueConfiguredReusableCell(using: footerCellRegistration, for: indexPath, item: headerCellConfiguration)
            case .promocode:
                let cell = collectionView.dequeueReusableCell(
                    withReuseIdentifier: TKContainerCollectionViewCell.reuseIdentifier,
                    for: indexPath
