...
final class SwapSearchTokenSuggestedCell: TKCollectionViewContainerCell<SwapSearchTokenSuggestedCellContentView> {}

final class SwapSearchTokenSuggestedCellContentView: UIView, ConfigurableView, TKCollectionViewCellContentView, ReusableView {
...
extension SwapSearchTokenSuggestedCellContentView {
    struct Model {
