...
enum TonConnectConnectMapper {
    private static func titleCaptionItem(
        wallet: Wallet,
                ...
                TKPopUp.Component.GroupComponent(
                    ...
                    items: [
                        TonConnectConnectWalletButtonComponent(
                            configuration: createListItemConfiguration(wallet: wallet, subtitle: try? wallet.friendlyAddress.toShort()),
                            action: {
                                walletPickerAction()
                            },
                            bottomSpace: 0
    ...
    private static func createListItemConfiguration(
        wallet: Wallet,
        subtitle: String? = nil
