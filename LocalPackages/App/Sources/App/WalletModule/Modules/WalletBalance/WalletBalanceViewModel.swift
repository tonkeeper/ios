    ...
    WalletBalanceModuleInput
{
    ...
    func createHeaderModel(totalBalanceModelState: WalletTotalBalanceModel.State, storiesState: StoriesStore.State) -> BalanceHeaderView.Model {
        ...
        return BalanceHeaderView.Model(
            ...
            buttonsViewModel: self.createHeaderButtonsModel(wallet: totalBalanceModelState.wallet),
    ...
    func createHeaderButtonsModel(wallet: Wallet) -> WalletBalanceHeaderButtonsView.Model {
        let sendButton: WalletBalanceHeaderButtonsView.Model.Button = WalletBalanceHeaderButtonsView.Model.Button(
