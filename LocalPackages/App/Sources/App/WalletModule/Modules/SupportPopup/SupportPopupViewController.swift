...
final class SupportPopupViewController: UIViewController, TKBottomSheetScrollContentViewController {
    private let viewModel: SupportPopupViewModel

    private let modalCardViewController = TKPopUp.ViewController()

    init(viewModel: SupportPopupViewModel) {
