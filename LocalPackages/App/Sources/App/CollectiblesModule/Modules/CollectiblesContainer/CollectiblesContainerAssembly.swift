...
struct CollectiblesContainerAssembly {
  private init() {}
  static func module(keeperCoreMainAssembly: KeeperCore.MainAssembly) -> MVVMModule<CollectiblesContainerViewController, CollectiblesContainerModuleOutput, CollectiblesContainerModuleInput> {
