...
final class ReceiveTRC20PopupViewController: UIViewController, TKBottomSheetScrollContentViewController {
    private let viewModel: ReceiveTRC20PopupViewModel

    private let modalCardViewController = TKPopUp.ViewController()

    init(viewModel: ReceiveTRC20PopupViewModel) {
