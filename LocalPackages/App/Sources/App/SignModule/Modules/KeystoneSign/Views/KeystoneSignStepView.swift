...
final class KeystoneSignStepView: UIView, ConfigurableView {
    ...
    struct Model {
        let contentModel: TKListItemContentView.Configuration
        let isFirst: Bool
        let isLast: Bool
    }

    func configure(model: Model) {
        contentView.configuration = model.contentModel
...
private extension KeystoneSignStepView {
    func setup() {
