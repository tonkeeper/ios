...
public final class TKModalCardViewController: UIViewController, TKBottomSheetScrollContentViewController {
    ...
    public let scrollView: UIScrollView = TKUIScrollView()
...
private extension TKModalCardViewController {
    ...
    func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            contentStackView.leftAnchor.constraint(
                equalTo: scrollViewContentView.leftAnchor,
                constant: 16
            ),
            contentStackView.rightAnchor.constraint(
                equalTo: scrollViewContentView.rightAnchor,
                constant: -16
            ),
