        ...
        public enum Icons {
            ...
            public enum Size16 {
                ...
                public static var exclamationmarkTriangle: UIImage {
                    .imageWithName("Icons/16/ic-exclamationmark-triangle-16")
                        .withRenderingMode(.alwaysTemplate)
                }
                ...
                public static var arrowDown: UIImage {
                    .imageWithName("Icons/16/ic-arrow-down-16")
                        .withRenderingMode(.alwaysTemplate)
                }
            }
            ...
            public enum Size28 {
                ...
                public static var importWalletOutline: UIImage {
                    .imageWithName("Icons/28/ic-import-wallet-outline-28")
                        .withRenderingMode(.alwaysTemplate)
                }
                ...
                public static var magnifyingGlassOutline: UIImage {
                    .imageWithName("Icons/28/ic-magnifying-glass-outline-28")
                        .withRenderingMode(.alwaysTemplate)
                }
                ...
                public static var testnetOutline: UIImage {
                    .imageWithName("Icons/28/ic-testnet-outline-28")
                        .withRenderingMode(.alwaysTemplate)
                }

                public static var tetraOutline: UIImage {
                    .imageWithName("Icons/28/ic-tetra-outline-28")
                        .withRenderingMode(.alwaysTemplate)
                }
                ...
                public static var questionMessage: UIImage {
                    .imageWithName("Icons/28/ic-question-message-outline-28")
                        .withRenderingMode(.alwaysTemplate)
                }

                public static var qrCode: UIImage {
                    .imageWithName("Icons/28/ic-qr-code-28")
                        .withRenderingMode(.alwaysTemplate)
                }
            }
            ...
            public enum Size128 {
                ...
                public static var textbook: UIImage {
                    .imageWithName("Icons/128/ic-textbook-128")
                }

                public static var notifications: UIImage {
                    .imageWithName("Icons/128/ic-notifications-128")
                }
            }
