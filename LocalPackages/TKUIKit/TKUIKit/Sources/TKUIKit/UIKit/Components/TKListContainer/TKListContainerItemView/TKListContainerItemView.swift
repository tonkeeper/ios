...
public final class TKListContainerItemView: TKPassthroughView, ConfigurableView {
    ...
    public func configure(model: Model) {
        ...
        if let captionButtonModel = model.captionButtonModel {
            ...
            captionButtonContainer.isHidden = false
        } else {
            captionButtonContainer.isHidden = true
        }
    ...
    private let captionButtonContainer = UIView()
    ...
    private func setup() {
        ...
        titleVerticalStackView.addArrangedSubview(captionButtonContainer)
        captionButtonContainer.addSubview(captionButton)
    ...
    private func setupConstraints() {
        ...
        captionButton.snp.makeConstraints { make in
            make.top.left.bottom.equalTo(captionButtonContainer)
            make.right.lessThanOrEqualTo(captionButtonContainer)
        }
    }
}
