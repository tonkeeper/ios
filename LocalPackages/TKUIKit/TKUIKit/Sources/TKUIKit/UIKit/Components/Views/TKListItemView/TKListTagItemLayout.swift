...
public struct TKListTagItemLayout {
  let iconView: UIView?
  ...
  public func calculateSize(targetSize: CGSize) -> CGSize {
    ...
    let resultWidth = [targetSize.width, 16 + iconViewFittingSize.width + contentViewFittingSize.width + valueViewFittingSize.width + valueViewLeftInset].min()!
...
private extension CGFloat {
  static let iconViewRightInset: CGFloat = 4
  static let valueViewLeftInset: CGFloat = 4
}
