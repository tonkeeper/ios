...
public final class TKListItemTextContentView: UIView {
    public struct Configuration: Hashable {
        ...
        public let isCenterVertical: Bool
        ...
        public init(
            ...
            self.isCenterVertical = isCenterVertical
        }
    ...
    override public func sizeThatFits(_ size: CGSize) -> CGSize {
        ...
        let height: CGFloat = {
            ...
            let rightHeight = layout.valueViewFrame.height + layout.valueCaptionViewFrame.height + layout.subvalueViewFrame.height
    ...
    private func didUpdateConfiguration() {
        ...
        for configuration in configuration.captionViewsConfigurations {
    ...
    private func calculateLayout(size: CGSize) -> Layout {
        ...
        if configuration.isCenterVertical,
           valueCaptionView.isHidden,
