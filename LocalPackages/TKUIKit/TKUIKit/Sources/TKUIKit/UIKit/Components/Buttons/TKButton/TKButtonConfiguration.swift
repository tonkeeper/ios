...
public extension TKButton {
    struct Configuration {
        ...
        public var borderColors: [TKButtonState: UIColor]
        ...
        public init(
            ...
            borderColors: [TKButtonState: UIColor] = [:],
            action: (() -> Void)? = nil
        ) {
...
public extension TKButton.Configuration {
    static func actionButtonConfiguration(
        category: TKActionButtonCategory,
        size: TKActionButtonSize
    ...
    static func fieldClearButtonConfiguration() -> TKButton.Configuration {
        TKButton.Configuration(
