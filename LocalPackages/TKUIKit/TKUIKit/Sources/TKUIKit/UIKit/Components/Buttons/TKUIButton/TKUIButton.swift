...
open class TKUIButton<ButtonContentView: UIView & ConfigurableView, ButtonBackgroundView: UIView>: UIControl, ConfigurableView, TKUIAsyncButtonContentView {
    ...
    private lazy var backgroundViewTopConstraint: NSLayoutConstraint = backgroundView.topAnchor.constraint(equalTo: topAnchor, constant: padding.top)

    private lazy var backgroundViewLeftConstraint: NSLayoutConstraint = backgroundView.leftAnchor.constraint(equalTo: leftAnchor, constant: padding.left)

    private lazy var backgroundViewBottomConstraint: NSLayoutConstraint = backgroundView.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -padding.bottom)

    private lazy var backgroundViewRightConstraint: NSLayoutConstraint = backgroundView.rightAnchor.constraint(equalTo: rightAnchor, constant: -padding.right)
