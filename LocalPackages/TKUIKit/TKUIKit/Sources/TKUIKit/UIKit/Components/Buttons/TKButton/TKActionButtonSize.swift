...
public enum TKActionButtonSize {
  ...
  public var padding: UIEdgeInsets {
    ...
    case .mediumMinus: return .init(top: 7, left: 16, bottom: 9, right: 16)
  ...
  public var textStyle: TKTextStyle {
    ...
    case .mediumMinus: return .label1
