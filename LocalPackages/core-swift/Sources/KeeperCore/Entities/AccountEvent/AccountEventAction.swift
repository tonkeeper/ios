...
public struct AccountEventAction: Codable, Sendable {
    public let type: ActionType
    public let status: AccountEventStatus
    public let preview: SimplePreview

    public struct SimplePreview: Codable, Sendable {
    ...
    public struct Purchase: Codable {
        public let source: WalletAccount
        public let destination: WalletAccount
        public let invoiceId: String
        public let amount: TokenAmount
        public let metadata: Metadata
    }

    public struct TokenAmount: Codable {
        public let value: String
    ...
    public struct Metadata: Codable {
        public let encryptedBinary: String?
    }
