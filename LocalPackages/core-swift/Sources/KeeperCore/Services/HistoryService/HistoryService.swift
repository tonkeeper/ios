...
public protocol HistoryService {
  ...
  func cachedEvents(wallet: Wallet, jettonInfo: JettonInfo) throws -> [HistoryEvent]
  func saveEvents(events: [HistoryEvent], wallet: Wallet) throws
  func saveEvents(events: [HistoryEvent], jettonInfo: JettonInfo, wallet: Wallet) throws
