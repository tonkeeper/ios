...
public struct MigrationV1 {
  ...
  public func migrateKeeperInfo() {
    ...
    do {
      ...
      let walletKind: Version11V1.WalletKind
      ...
      let wallet = Version11V1.Wallet(
        identity: Version11V1.WalletIdentity(
          network: .mainnet,
          kind: walletKind
        ),
        metaData: Version11V1.WalletMetaData(
          label: "Wallet",
          tintColor: .steelGray,
          emoji: "👽"
        ),
      ...
      let keeperInfo = Version11V1.KeeperInfo(
        wallets: [wallet],
  ...
  private func needToMigrate() -> Bool {
    ...
    do {
      let version_1_0_0_KeeperInfo = try version_1_0_0_Vault.loadItem(key: "KeeperInfo")
      return !version_1_0_0_KeeperInfo.wallets.isEmpty
    } catch {
      return false
    }
  }
