...
public struct UnsignedTransferBuilder {
    ...
    public func createUnsignedWalletTransfer(wallet: Wallet) async throws -> WalletTransfer {
        ...
        case .swap:
            fatalError()
        case let .tonConnect(tonConnect):
        ...
        case let .changeDNSRecord(changeDNSRecord):
            switch changeDNSRecord {
            case let .link(linkDNS):
        ...
        case let .stake(stake):
            ...
            case let .withdraw(stakeWithdraw):
