...
public struct RNMnemonicsVault {
    ...
    public func getEncryptedMnemonics() throws -> EncryptedMnemonics {
        return try loadEncryptedMnemonics()
    }
...
private extension RNMnemonicsVault {
    ...
    func decryptMnemonics(_ encryptedMnemonics: EncryptedMnemonics, password: String) async throws -> Mnemonics {
        ...
        return decrypted.compactMapValues {
