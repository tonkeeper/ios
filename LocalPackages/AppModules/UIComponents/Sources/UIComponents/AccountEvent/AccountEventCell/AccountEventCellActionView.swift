...
public final class AccountEventCellActionView: UIControl, ConfigurableView, ReusableView {
  ...
  let iconView = AccountEventCellIconView()
  ...
  let inProgressLoaderView = AccountEventCellLoaderView()
  ...
  public struct Model {
    public let iconConfiguration: AccountEventCellIconView.Configuration
    public let contentConfiguration: TKUIListItemContentView.Configuration
    public let commentConfiguration: CommentView.Configuration?
    public let encryptedCommentConfiguration: EncyptedCommentView.Model?
    public let descriptionConfiguration: CommentView.Configuration?
    public let nftConfiguration: NFTView.Configuration?
    public let isInProgress: Bool
    
    public init(iconConfiguration: AccountEventCellIconView.Configuration,
                contentConfiguration: TKUIListItemContentView.Configuration,
                commentConfiguration: CommentView.Configuration?,
                encryptedCommentConfiguration: EncyptedCommentView.Model?,
                descriptionConfiguration: CommentView.Configuration?,
                nftConfiguration: NFTView.Configuration?,
                isInProgress: Bool) {
...
private extension AccountEventCellActionView {
  func setup() {
