...
public protocol AccountEventModelActionContentProvider {
    func title(actionType: AccountEventModel.Action.ActionType, customName: String?) -> String
}

public struct HistoryAccountEventActionContentProvider: AccountEventModelActionContentProvider {
    public init() {}

    public func title(actionType: AccountEventModel.Action.ActionType, customName: String?) -> String {
        switch actionType {
        case .sent:
        ...
        case .purchase:
            return TKLocales.ActionTypes.purchase
        case .bid:
        ...
        case .unknown:
            return customName ?? TKLocales.ActionTypes.unknown
        }
    }
}

public struct SignRawAccountEventActionContentProvider: AccountEventModelActionContentProvider {
    public init() {}
    ...
    public func title(actionType: AccountEventModel.Action.ActionType, customName: String?) -> String {
        ...
        case .putUpForSale:
            return TKLocales.ActionTypes.sent
        case .domainRenew:
            return TKLocales.ActionTypes.Future.domainRenew
        case .unknown:
            return customName ?? TKLocales.ActionTypes.unknown
        }
    }
